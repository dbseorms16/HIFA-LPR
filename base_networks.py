...
class final_UpBlocks(torch.nn.Module):
    def __init__(self, num_filter, kernel_size=8, stride=4, padding=2, bias=True, activation='prelu', norm=None):
        super(final_UpBlocks, self).__init__()
        ...
        self.up_conv3 = DeconvBlock(num_filter, 64, kernel_size, stride, padding, activation, norm=None)   
        
        # self.up_conv3=torch.nn.ConvTranspose2d(64, 3, 8, 4, 2)
